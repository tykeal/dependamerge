...
from .models import PullRequestInfo, FileChange
...
class GitHubClient:
    ...
    def get_pull_request_info(self, owner: str, repo: str, pr_number: int) -> PullRequestInfo:
    ...
    def get_organization_repositories(self, org_name: str) -> List[Repository]:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to fetch organization repositories: {e}")
    ...
    def approve_pull_request(self, owner: str, repo: str, pr_number: int, message: str = "Auto-approved by dependamerge") -> bool:
    ...
    def merge_pull_request(self, owner: str, repo: str, pr_number: int, merge_method: str = "merge") -> bool:
