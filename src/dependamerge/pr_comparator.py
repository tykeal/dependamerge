...
class PRComparator:
    ...
    def compare_pull_requests(self, source_pr: PullRequestInfo, target_pr: PullRequestInfo) -> ComparisonResult:
        ...
        files_score = self._compare_file_changes(source_pr.files_changed, target_pr.files_changed)
    ...
    def _is_automation_pr(self, pr: PullRequestInfo) -> bool:
        ...
        automation_indicators = [
            'dependabot', 'pre-commit', 'renovate', 'github-actions',
            'auto-update', 'automated', 'bot'
        ]
