...
class TestPRComparator:
    ...
    def test_compare_file_changes_identical(self):
        ...
        files1 = [
            FileChange(filename="requirements.txt", additions=1, deletions=1, changes=2, status="modified"),
            FileChange(filename="setup.py", additions=1, deletions=1, changes=2, status="modified")
        ]
        files2 = [
            FileChange(filename="requirements.txt", additions=2, deletions=1, changes=3, status="modified"),
            FileChange(filename="setup.py", additions=1, deletions=2, changes=3, status="modified")
        ]
    ...
    def test_compare_file_changes_partial_overlap(self):
        ...
        files2 = [
            FileChange(filename="requirements.txt", additions=1, deletions=1, changes=2, status="modified"),
            FileChange(filename="package.json", additions=1, deletions=1, changes=2, status="modified")
        ]
